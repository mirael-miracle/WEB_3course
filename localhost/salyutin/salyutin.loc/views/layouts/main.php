        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="about-content">Привет, это мой блог, в котором я выкладываю статьи на музыкальную тематику.
                    </div>
                    <div class="address">
                        <h4 class="text-uppercase">Мои контакты:</h4>

                        <p>Адрес такой адрес :)</p>
